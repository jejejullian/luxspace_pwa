...
async function subscribe() {
  const key = "BNS4IJnf4LF-P77wvQ7syTLSw0teAUiLgT_tYOdKPWnrKbw6sV5RhnKQEoSP77OO_w_9hkWZ3IINcRO-oMQAwew";
        ...
        <div className="container mx-auto py-5">
          <div className="flex flex-stretch items-center">
            ...
            <div className="w-auto">
              <ul className="fixed bg-white inset-0 z-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center" id="menu">
            ...
            <div className="w-auto">
              <ul className="items-center flex">
                <li className="ml-6 block md:hidden">
                  <button id="menu-toggler" className="relative flex z-50 items-center justify-center w-8 h-8 text-black md:text-black focus:outline-none">
                ...
                <li className="ml-6">
                  <a id="header-cart" href="cart.html" className="flex items-center justify-center w-8 h-8 text-black cart cart-filled">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-full md:w-4/12 text-center">
              <div className="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 mt-20">
                <img src="./images/content/my-profile.png" alt="my-profile" className="object-cover w-full h-full" />
              </div>
